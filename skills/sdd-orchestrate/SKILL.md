...
re-branch are the workstream branch and the boundary-error inference is removed
— `references/fan-out.md` §0/§3c, [`references/v4-workstreams.md`](references/v4-workstreams.md) §Marker-4 anchor.
