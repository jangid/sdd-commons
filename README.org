...
=replan=, =migrate=, and =review= as cross-cutting skills.

=orchestrate= is a *driver* that runs the whole suite as a single-operator
...
the operator guide:
[[file:skills/orchestrate/USAGE.md][skills/orchestrate/USAGE.md]].
